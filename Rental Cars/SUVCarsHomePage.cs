...
{
    [Activity(Label = "SUVCarsHomePage")]
    public class SUVCarsHomePage : Fragment
    {
        ListView myList;
        Activity context;
        Realm realmObj;
        ...
        public SUVCarsHomePage(Activity cxt)
        {
            this.context = cxt;
        }
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            var view = inflater.Inflate(Resource.Layout.SUVCarsHome, container, false);
            myList = view.FindViewById<ListView>(Resource.Id.SUVCarsListId);
            mySearch = view.FindViewById<SearchView>(Resource.Id.SUVCarsSearchId);
